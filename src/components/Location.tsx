    ...
    <section id="location" className="py-24 bg-black relative z-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="group relative w-full h-[450px] rounded-3xl overflow-hidden border-4 border-[#39FF14]/20 shadow-[0_0_50px_rgba(0,0,0,0.5)] transition-all duration-500 hover:border-[#39FF14]/50">
            {/* Standard Light Map */}
            <iframe 
